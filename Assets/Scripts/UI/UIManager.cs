...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField]
    private Button PlayerBet_Button;
    [SerializeField]
    private Button BankerBet_Button;
    [SerializeField]
    private Button TieBet_Button;
    ...
    private void Start()
    {
        ...
        if (MainBet_Button) PlayerBet_Button.onClick.RemoveAllListeners();
        if (MainBet_Button) PlayerBet_Button.onClick.AddListener(delegate { OnBet(true); });
